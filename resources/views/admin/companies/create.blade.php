  ...
  <form action="{{ route('admin.companies.store') }}" method="POST"
    ...
    <div class="px-6 py-6 sm:px-8 sm:py-7 space-y-6">
      ...
      <div class="flex items-center justify-between gap-3 pb-3 border-b border-slate-100">
        <div>
          ...
          <p class="text-xs text-slate-500 mt-0.5">
            Pastikan kode unik karena akan dipakai di berbagai modul.
          </p>
        </div>
      </div>
        ...
        <div class="sm:col-span-1 flex items-end">
          <label class="inline-flex items-center gap-2 mt-6">
            <input id="is_active" type="checkbox" name="is_active" value="1"
                   class="rounded border-slate-300 text-maroon-700 focus:ring-maroon-600/40"
      ...
      <div class="pt-3 flex items-center justify-end gap-2 border-t border-slate-100">
        ...
        <button type="submit"
                class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-maroon-700 text-white text-sm font-semibold shadow hover:bg-maroon-800">
