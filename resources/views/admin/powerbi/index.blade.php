...
<div class="rounded-3xl shadow ring-1 ring-slate-200 bg-white overflow-hidden">
  ...
  {{-- TOOLBAR (seragam dengan Sites/Divisions) --}}
        ...
        @forelse($reports as $r)
          ...
          <tr class="{{ $isDeleted ? 'bg-rose-50/40' : 'hover:bg-slate-50' }}"
            ...
            <td class="px-4 py-3 align-top text-right">
              ...
              <form x-ref="deleteFormSoft-{{ $r->id }}" class="hidden" method="POST" action="{{ route('admin.powerbi.destroy',$r) }}">
                @csrf @method('DELETE')
              </form>
                  ...
                  <div x-show="confirmDelete"
                    ...
                    <div class="px-5 py-4 flex items-center justify-end gap-2.5">
                      ...
                      <button :class="(ack && text==='HAPUS') ? 'opacity-100' : 'opacity-50 cursor-not-allowed'"
                              ...
                              @click="( {{ $isDeleted ? '$refs[`deleteFormHard-'.$r->id.'`]' : '$refs[`deleteFormSoft-'.$r->id.'`]' }} ).submit()"
