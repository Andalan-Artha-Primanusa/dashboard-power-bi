  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    @forelse($reports as $r)
      <a href="{{ route('powerbi.show',$r) }}"
        ...
        <div class="flex items-center justify-between mb-3">
          <div class="h-10 w-10 rounded-full bg-maroon-700 flex items-center justify-center text-white font-bold shadow">
            BI
          </div>
        ...
        {{-- Title --}}
        <h2 class="text-lg font-semibold text-slate-800 group-hover:text-maroon-700 transition">
          {{ $r->name }}
        </h2>
    ...
    @empty
      <div class="col-span-full">
        <div class="rounded-xl bg-white text-maroon-800 px-4 py-3 text-sm border border-maroon-200">
          Kamu belum punya akses ke dashboard.
        </div>
      </div>
    @endforelse
  </div>
